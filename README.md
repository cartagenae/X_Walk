...
__*** If you're running X Walk from a Mac or Linux, \nthen Git and Python are already installed in your system.__
...
Type 'python3 x_walk.py'
If you're using Windows type 'python x_walk.py'
