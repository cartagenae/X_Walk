...
__*** If you're running X Walk from the latest version of either MacOS or any Linux distribution, then Git and Python should be already installed in your system.__
